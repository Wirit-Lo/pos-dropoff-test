...
def run_smart_scenario(main_window, config):
    ...
    wait_until_id_appears(main_window, "ShippingService_361925", timeout=wait_timeout)
     # คลิก 1 ครั้ง
    if not find_and_click_with_rotate_logic(main_window, "ShippingService_361925"):
        log("[Error] หาปุ่มบริการไม่เจอ (ShippingService_361925)")
        return
