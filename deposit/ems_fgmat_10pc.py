...
def run_smart_scenario(main_window, config):
    try:
        ...
        product_detail = "อุปกรณ์ไก่ชน ม้วนพรมไก่ ไม่เกิน 10 ผืน"
    ...
    wait_until_id_appears(main_window, "ShippingService_363165", timeout=15)
    if find_and_click_with_rotate_logic(main_window, "ShippingService_363165"):
        main_window.type_keys("{ENTER}")
