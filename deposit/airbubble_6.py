...
def run_smart_scenario(main_window, config):
    try:
        ...
        product_detail = "วัสดุกันกระแทก (Air bubble) แบบม้วน 35+35+130 ซม."
    ...
    wait_until_id_appears(main_window, "ShippingService_363240", timeout=15)
    if find_and_click_with_rotate_logic(main_window, "ShippingService_363240"):
