...
def run_smart_scenario(main_window, config):
    try:
        ...
        product_detail = "อุปกรณ์ไก่ชน สุ่มวิ่งไก่ สุ่ม 2 ชั้น (พับได้) 1 ใบ"
    ...
    wait_until_id_appears(main_window, "ShippingService_363176", timeout=15)
    if find_and_click_with_rotate_logic(main_window, "ShippingService_363176"):
        main_window.type_keys("{ENTER}")
